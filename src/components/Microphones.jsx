  ...
  const mics = [
    {
      ...
      description: 'Plug-and-play USB mic ideal for streaming, podcasting, and remote calls.',
      price: '$149',
      image:
    ...
    {
      id: 2,
      name: 'Broadcast Dynamic Microphone',
      description: 'Broadcast-style dynamic mic with tight pickup and rich, present tone.',
      price: '$299',
      image:
        'https://m.media-amazon.com/images/I/61ElAcEsHiL._AC_UF1000,1000_QL80_.jpg',
      tag: 'Broadcast',
      type: 'Dynamic',
    },
    {
      ...
      description: 'Large-diaphragm condenser mic for studio vocals and instruments.',
      price: '$399',
      image:
        'https://poojaelectronics.in/storage/2023/04/Rode-NT1-5th-Generation-Large-Diaphragm-Cardioid-Condenser-Microphone-Online-Buy-India_01.jpg',
      tag: 'Studio',
      type: 'XLR condenser',
    },
    {
      id: 4,
      name: 'Handheld Vocal Microphone',
      description: 'Rugged cardioid mic designed for live vocals and stage use.',
      price: '$129',
      image:
        'https://m.media-amazon.com/images/I/61XZgWJwg0L.jpg',
      tag: 'Live',
      type: 'Dynamic handheld',
    },
    {
      id: 5,
      name: 'Podcast Microphone Bundle',
      description: 'Desktop boom arm, pop filter, and USB mic bundle for turnkey podcast setups.',
      price: '$219',
      image:
        'https://m.media-amazon.com/images/I/71y4K7PaSGL._AC_UF1000,1000_QL80_.jpg',
      tag: 'Bundle',
      type: 'USB bundle',
    },
    {
      id: 6,
      name: 'Lavalier Microphone Kit',
      description: 'Clip-on lavalier mic kit for interviews, presentations, and mobile content.',
      price: '$99',
      image:
        'https://m.media-amazon.com/images/I/715S5hKK8mL._AC_UF1000,1000_QL80_.jpg',
      tag: 'Mobile',
      type: 'Lavalier',
    },
  ];

  const filteredMics = mics.filter((item) => {
      ...
      <main>
        ...
        >
          <div className="d-flex justify-content-between align-items-center mb-4">
            <div>
              <h1 className="display-5 fw-bold mb-2">Microphones</h1>
              <p className="text-secondary mb-0">
                Capture your voice and instruments clearly, whether youre streaming, recording, or performing live.
              </p>
            </div>
            <span className="badge bg-warning text-dark">Mic selection</span>
          </div>

          <div className="d-flex flex-wrap align-items-center justify-content-between mb-3">
            <span className="small text-secondary mb-2 mb-md-0">
              Filter microphones by type to match your use case.
            </span>
            <div className="d-flex align-items-center gap-2">
              <label htmlFor="micTypeFilter" className="small text-secondary mb-0">
                Type:
              </label>
              <select
                id="micTypeFilter"
              ...
              >
                ...
                <option value="USB condenser">USB condenser</option>
                <option value="Dynamic">Dynamic</option>
                <option value="XLR condenser">XLR condenser</option>
          ...
          <div className="row g-4" data-aos="fade-up" data-aos-delay="250">
            <div className="col-lg-6">
              <div className="card h-100 bg-black text-light border-0 shadow-sm">
                <div className="card-body">
                  <h2 className="h4 mb-3">Dynamic vs condenser</h2>
                  <p className="small text-secondary mb-3">
                    Dynamic mics excel in untreated rooms and live stages. Condenser mics capture more detail but
                    prefer quieter, controlled spaces.
                  </p>
                  <ul className="small text-secondary mb-0">
                    <li>Dynamic: great for close-up vocals, podcasts, and live sound</li>
                    <li>Condenser: perfect for studio vocals, acoustic instruments, and detailed recording</li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div className="col-lg-6">
              <div className="hero-card rounded-4 p-4 p-md-5 bg-gradient h-100">
                <h2 className="h4 mb-3">Need help picking a mic?</h2>
                <p className="small text-secondary mb-3">
                  Tell us about your setup and voice, and we'll recommend microphones that match your tone and
